...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['100K queries/mo', 'Ad + tracker blocking', '50ns Bloom Filter lookup', 'Community support'] },
  { name: 'Pro', price: '$19/mo', features: ['Unlimited queries', 'Ad + tracker + malware blocking', 'Custom blocklists & allowlists', 'Query analytics', 'Family protection', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited everything', 'Custom filtering rules', 'API access', 'Team management', 'SLA 99.999%', 'Dedicated support'] },
];
